export const orbitABI = [
    ...
    { inputs: [], name: 'BlastTransferFailed', type: 'error' },
    { inputs: [], name: 'BlastYieldOwnerCheck', type: 'error' },
    ...
    },
    {
        ...
        name: '_blastClaimYieldAll',
        outputs: [{ internalType: 'uint256', name: '', type: 'uint256' }],
        stateMutability: 'nonpayable',
        type: 'function',
    },
    { inputs: [], name: '_blastConfigureYield', outputs: [], stateMutability: 'nonpayable', type: 'function' },
    {
        inputs: [],
        name: '_blastGetClaimableAmount',
        outputs: [
    ...
    {
        inputs: [
            { internalType: 'contract ComptrollerInterface', name: 'spaceStation_', type: 'address' },
            { internalType: 'contract InterestRateModel', name: 'interestRateModel_', type: 'address' },
            { internalType: 'uint256', name: 'initialExchangeRateMantissa_', type: 'uint256' },
            { internalType: 'string', name: 'name_', type: 'string' },
            { internalType: 'string', name: 'symbol_', type: 'string' },
    ...
    },
    {
        inputs: [
            ...
            { internalType: 'contract OTokenV2', name: 'oTokenCollateral', type: 'address' },
        ],
        name: 'liquidateBorrow',
        outputs: [],
        stateMutability: 'payable',
    ...
    { inputs: [], name: 'repayBorrow', outputs: [], stateMutability: 'payable', type: 'function' },
    {
